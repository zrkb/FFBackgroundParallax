...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Felix Ayala"
  # s.authors            = { "Felix Ayala" => "" }
  # s.social_media_url   = "http://twitter.com/Felix Ayala"
  ...
  s.source       = { :git => "https://github.com/rockbarato/FFBackgroundParallax.git", :tag => "1.0.0" }
